...
<form action="/adtask" method="post" onSubmit="return check()">
{{ csrf_field() }}
...
<td>DESCRIPTION</td>
<td><input type="text" name="desc" id="desc" value="{{old('desc')}}" required ></td>

</tr><tr><td><br></td></tr>

<td>DUE DATE</td>
<td><input type="date" name="date" id="date" value="{{old('date')}}" required ></td>
